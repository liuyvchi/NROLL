...
# ------------------- test LFW ---------------------------
DATA_ROOT = '/export/home/liuyc/data/'
...
def train_one_epoch(conf, data_loader, t, loss_fn, models, fc_ms, optimizers, rate_schedule, cur_epoch, saved_dir, print_freq=200):
    ...
    for batch_idx, (image, label) in enumerate(data_loader):
        ...
        for i in range(M):
            ...
            if batch_idx % print_freq == 0:
                ...
                print('epoch %d, iter %d, lr %f, model_m%f, loss_clean %f' % (cur_epoch, batch_idx, lr, i, loss_clean.item())) 
                print('epoch %d, iter %d, lr %f, model_m%f, loss_hc %f' % (cur_epoch, batch_idx, lr, i, loss_hc.item())) 
            ...
            if batch_idx != 0 and i == 0 and batch_idx in check_point_size:
                if cur_epoch > 10:
...
def train_on_neuhub(argv):
    ...
    conf.add_argument("--input_db_dir", type=str, default='/export/home/liuyc/data/CASIA/crop/', help="input database name")
    ...
    conf.add_argument('--mask', type=float, default=1.2, help='only take effect when trained on svfc')
    ...
    conf.add_argument('--epochs', type=int, default=30, help='how many epochs you want to train.')
    ...
    conf.add_argument("--agents_dir", type=str, default='./snapshot/0922_1/best', help="saved agents dir")
    conf.add_argument("--agents_dir", type=str, default='./snapshot/0922_1/best', help="saved agents dir")
